...
$('#graffiti').on('click', function() {
  $('#funcDesc').html('Graffiti for your punk ass style');
    currentFunction = new Graffiti(contextReal, lineColor);
  });
  $('#marker').on('click', function() {
    $('#funcDesc').html('Whiteboard Marker');
    currentFunction = new Marker(contextReal, lineColor);
  });
//------------------Selecter
$('#selector-button').on('click', function() {
  $('#funcDesc').html('Selector tool: allows you to cut out the ugly parts of your painting');
  currentFunction = new Selecting(contextReal, contextDraft);
});
//------------------Colors
$('#fill').on('click', function() {
  $('#funcDesc').html("Paint Fill when you're too lazy to do this manually");
...
$('#drawingEraser').on('click', function(){
  $('#funcDesc').html('Erase that nasty stuff');
...
$('#curve-line').on('click',function(){
  $('#funcDesc').html('Curved Lines: "Liam, I did this with NO help..." - Suruchi, 2019');
